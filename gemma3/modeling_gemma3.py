...
class Gemma3ForConditionalGeneration(Gemma3PreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **lm_kwargs,
        ...
        >>> messages = [
        transformers.     {
        transformers.         "role": "system",
        transformers.         "content": [
        transformers.             {"type": "text", "text": "You are a helpful assistant."}
        transformers.         ]
        transformers.     },
        transformers.     {
        transformers.         "role": "user", "content": [
        transformers.             {"type": "image", "url": "https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/pipeline-cat-chonk.jpeg"},
        transformers.             {"type": "text", "text": "Where is the cat standing?"},
        transformers.         ]
        transformers.     },
        transformers. ]
        ...
        transformers.     tokenize=True,
        transformers.     return_dict=True,
        transformers.     return_tensors="pt",
        transformers.     add_generation_prompt=True
        transformers. )
        >>> # Generate
        >>> generate_ids = model.generate(**inputs)
        >>> processor.batch_decode(generate_ids, skip_special_tokens=True, clean_up_tokenization_spaces=False)[0]
        ...
        if labels is not None:
            ...
            logits = logits.float()
            shift_logits = logits[transformers., :-1, :]
            shift_labels = labels[transformers., 1:]
